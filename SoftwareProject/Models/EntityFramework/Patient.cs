...
namespace SoftwareProject.Models.EntityFramework
{
    ...
    public partial class Patient
    {
        ...
        [RegularExpression("([A-ZÇÝÖÞÜÐ]+[a-zçÐIÖÞÜ]+)", ErrorMessage = "Please Enter Valid Name")]
        public string Name { get; set; }
        [Required(ErrorMessage = "Surnaame is Required")]
        [RegularExpression("([A-ZÇÝÖÞÜÐ]+[a-zçÐIÖÞÜ]+)", ErrorMessage = "Please Enter Valid Surname")]
